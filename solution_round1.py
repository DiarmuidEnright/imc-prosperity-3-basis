...
class AltAshCoatedOsmiumTrader:
    """
    ASH_COATED_OSMIUM alternative: dynamic bot-wall detection + multi-level
    quoting + insider amplification + three-tier inventory skew.

    Data context:
      - FV permanently ~10 000.
      - Bot walls confirmed at mid +/- 8 (dominant), with outer layers at
        +/- 9.5-12. Position limit: 30.
    """

    FV:         int   = 10_000
    LIMIT:      int   = ASH_LIMIT
    MAX_OFFSET: int   = 8      # quotes in [FV-8, FV-1] / [FV+1, FV+8]
